<head>
        <meta charset="utf-8" />
        <title>Captain Food | Dashboard</title>
        ...
        <link href="<?php echo assets_url()?>adminassets/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo assets_url()?>adminassets/assets/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo assets_url()?>adminassets/assets/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo assets_url()?>adminassets/assets/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />
