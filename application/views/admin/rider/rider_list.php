        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Riders List
                ...
                <!-- BEGIN EXAMPLE TABLE PORTLET-->
							<div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                       <i class="icon-settings font-green"></i>
                                        <span class="caption-subject bold uppercase">Riders Listing</span>
									</div>
                                    
                                </div>
                                <div class="portlet-body flip-scroll">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" id="riders_table">
                                        <thead >
                                            <tr>
                                                <th> Sr # </th>
                                                <th> Name </th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rider['Contact']; ?></td>
									<td><?php echo $rider['Address']; ?></td>
                                         <td><a href="<?php echo base_url().'rider/edit_rider/'.$chef['RiderID']; ?>">Edit</a> | 
                                        <a href="javascript:" onclick="delete_chef('<?php echo $chef['RiderID']; ?>')">Delete</a>                                     </td>
                                </tr>
                                        <?php
                                    }
                                }
